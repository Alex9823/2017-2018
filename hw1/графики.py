...
def saveposts():
    ...
    f_ids = []
    length_t = []
    p_number = number('https://api.vk.com/method/wall.get?owner_id=-31798109&count=1&offset=0&v=5.73&access_token=32ce1a8532ce1a8532ce1a856232ac36aa332ce32ce1a85680fd3cd59e166579eb694c4')
    h = math.ceil(p_number/100)
    o = 0
    s = 100
    for i in range(0, h):
        if i <= 100: 
            link = 'https://api.vk.com/method/wall.get?owner_id=-31798109&count=100&offset=' + str(o) + '&v=5.73&access_token=32ce1a8532ce1a8532ce1a856232ac36aa332ce32ce1a85680fd3cd59e166579eb694c4'
...
def save():
    ...
    for i in range(len(p_ids)):
        n = 0
        p = 0
        link = 'https://api.vk.com/method/wall.getComments?owner_id=-31798109&post_id=' + str(p_ids[i]) + '&count=100&v=5.73&access_token=32ce1a8532ce1a8532ce1a856232ac36aa332ce32ce1a85680fd3cd59e166579eb694c4'
        c_number = number(link)
        c_numbers.append(c_number) 
        if c_number != 0:
            h = math.ceil(c_number/100)
            for j in range(0, h):
                link = 'https://api.vk.com/method/wall.getComments?owner_id=-31798109&post_id=' + str(p_ids[i]) + '&offset=' + str(o) + '&count=100&v=5.73&access_token=32ce1a8532ce1a8532ce1a856232ac36aa332ce32ce1a85680fd3cd59e166579eb694c4'
                data, result = datas(link)
                if c_number <= 100:
                    for k in range(0, c_number):
                        ...
                        if re.search(extra, allwords):
                            allwords = re.sub(extra, "", allwords)
